...
public class EstadoRest {
	...
	//GUARDAR ESTADO
		...
		private Estado guardarEstado(@RequestBody Estado estado) {
		    try {
		        Estado estadoGuardado = estadoService.saveEstado(estado);
		        return estadoGuardado;
		    } catch (Exception e) {
		        e.printStackTrace();
		        throw new RuntimeException("No se pudo guardar el Estado", e);
		    }
		}
